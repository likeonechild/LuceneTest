...
public class HighLightSearch {
	...
	public static void createIndex() {
		...
		try {
			...
			// 要搜索的File路径
			File dFile = new File("D:\\luceneData");
			...
			for (File file : files) {
				...
				/*document.add(new TextField("content", new BufferedReader(new FileReader(file)).toString(), Store.NO));
	...
	public static void search(String keyWord) {
		...
		try {
			...
			System.out.println("查找到的文档总共有：" + topDocs.totalHits+"个");
